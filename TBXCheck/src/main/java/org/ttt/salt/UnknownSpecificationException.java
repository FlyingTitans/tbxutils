 ...
 */
public class UnknownSpecificationException extends XCSValidationException
{
    /*
     */
     ...
     */
    public UnknownSpecificationException(Element elem)
    {
        super(elem);
    }
    ...
    public String getMessage()
    {
        ...
        buf.append("Unknown specification pair (");
