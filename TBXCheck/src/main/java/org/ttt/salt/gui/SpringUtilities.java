...
public final class SpringUtilities
{
     ...
     *
     * @param c The {@link java.awt.Component} to print information about.
     */
     ...
     *
     * @param parent The container to be operated on.
    ...
    /**
     * Get the layout constraints on a cell. Used by makeCompactGrid.
     *
     * @param row The row in the grid to access.
     * @param col The column in the grid to access.
     * @param parent The container to be operated on.
     * @param cols number of columns
