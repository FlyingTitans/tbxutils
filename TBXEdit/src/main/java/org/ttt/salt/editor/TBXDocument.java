 ...
 * @version $Id$
 */
public class TBXDocument extends ObservableDocument
    implements ObservableDocument.NodeListener
{
    /*
     */
    ...
    /** {@inheritDoc} */
    public void childAdded(ObservableDocument doc, Node node,
            Node child)
    {
        dirty = true;
    ...
    /** {@inheritDoc} */
    public void childRemoved(ObservableDocument doc, Node node,
            Node child)
    {
        dirty = true;
        if (child instanceof Element)
    ...
    /** {@inheritDoc} */
    public void parentAdded(ObservableDocument doc, Node node,
            Node parent)
    {
        dirty = true;
    }
    ...
    /** {@inheritDoc} */
    public void parentRemoved(ObservableDocument doc, Node node,
            Node parent)
    {
        dirty = true;
    }
    ...
    /** {@inheritDoc} */
    public void setUserData(ObservableDocument doc, Node node, String key,
