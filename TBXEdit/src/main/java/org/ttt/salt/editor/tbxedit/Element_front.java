 ...
 * @version $Id$
 */
public class Element_front extends XMLElement
{
    /*
     */
     ...
     */
    public Element_front(Element elem, TreeView window, String title)
    {
    ...
    {
        contentPanel.add(new JLabel(BUNDLE.getString("front_text")));
