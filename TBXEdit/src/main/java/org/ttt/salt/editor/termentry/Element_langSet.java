 ...
 * @version $Id$
 */
public class Element_langSet extends TermEntryElement
{
    /*
     */
     ...
     */
    public Element_langSet(Element elem, TreeView window, String title)
    {
    ...
    public void validateAndSaveAttribute_lang(ActionEvent evt)
    {
        ...
        if (!value.equals(elem.getAttribute("xml:lang")))
