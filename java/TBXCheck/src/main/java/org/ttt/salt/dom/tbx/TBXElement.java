...
/**
 * This is the base class for all elements in an TBX XML Document.
 * <p>
 * This is designed to add a few extra methods to the {@link org.w3c.dom.Element}
 * interface to allow validation and output of an TBX element in well-formed
 * valid XML format.</p>
 *
 ...
 */
public class TBXElement extends ElementImpl implements Element
{
    /*
     */
     ...
     */
    public TBXElement(TBXDocument ownerDoc, String name, Locator loc)
    {
        super(ownerDoc, name);
        if (loc != null)
        {
