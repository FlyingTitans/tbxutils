...
public class UTFStreamReader extends Reader
{
	...
	throws UnsupportedEncodingException, IOException
	{
		...
		{ //UTF-8 one byte check first character for valid UTF-8
			ret = "UTF-8";
		}
		else if ((b0 & 0xE0) == 0xC0 && (b1 & 0xC0) == 0x80)
		{ //UTF-8 two byte check first character for valid UTF-8
			ret = "UTF-8";
		}
		else if ((b0 & 0xF0) == 0xE0 && (b1 & 0xC0) == 0x80 && (b2 & 0xC0) == 0x80)
		{ //UTF-8 three byte check first character for valid UTF-8
			ret = "UTF-8";
		}
		else if ((b0 & 0xF8) == 0xF0 && (b1 & 0xC0) == 0x80 && (b2 & 0xC0) == 0x80 && (b2 & 0xC0) == 0x80)
		{ //UTF-8 four byte check first character for valid UTF-8
			ret = "UTF-8";
		}
